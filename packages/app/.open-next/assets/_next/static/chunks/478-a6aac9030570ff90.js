  ...
  [478],
  {
                      ...
                      let e =
                        ...
                        s =
                          "function" == typeof a.description
                            ...
                            : a.description,
                        i =
                          "object" != typeof e || r.isValidElement(e)
                            ? { message: e }
                            : e;
                      this.create({
                        id: o,
    ...
    8309: (t, a, e) => {
      ...
      var r = e(7620),
        o = (t, a, e, r, o, s, n, i) => {
          ...
          function c(a) {
            ...
            (Array.isArray(t) ? t : [t]).forEach((t) => {
              let e = "class" === t,
                r = e && s ? o.map((t) => s[t] || t) : o;
              e
                ? (d.classList.remove(...r),
                  d.classList.add(s && s[a] ? s[a] : a))
                : d.setAttribute(t, a);
            }),
              (e = a),
              i && l.includes(e) && (d.style.colorScheme = e);
          }
          if (r) c(r);
          else
            try {
        ...
        l = () => {
          var t;
          return null != (t = r.useContext(i)) ? t : d;
        },
        c = (t) =>
          r.useContext(i)
        ...
        u = (t) => {
          let {
            ...
            [k, T] = r.useState(() => h(l, u)),
            [E, S] = r.useState(() => ("system" === k ? g() : k)),
                ...
                let r = y ? y[a] : a,
                  ...
                  l = (t) => {
                    "class" === t
                      ...
                      : t.startsWith("data-") &&
                        (r ? i.setAttribute(t, r) : i.removeAttribute(t));
                  };
                if ((Array.isArray(b) ? b.forEach(l) : l(b), d)) {
                  let t = s.includes(u) ? u : null,
                    e = s.includes(a) ? a : t;
                  i.style.colorScheme = e;
                }
                null == n || n();
              },
              [x]
            ...
            z = r.useCallback(
              (t) => {
                S(g(t)), "system" === k && o && !a && Y("system");
              },
              [k, a]
            );
          r.useEffect(() => {
            let t = window.matchMedia(n);
            return t.addListener(z), z(t), () => t.removeListener(z);
          }, [z]),
            r.useEffect(() => {
              let t = (t) => {
                t.key === l && (t.newValue ? T(t.newValue) : j(u));
              };
              return (
        ...
        f = r.memo((t) => {
          let {
            ...
            f = JSON.stringify([s, e, d, a, c, l, n, i]).slice(1, -1);
        ...
        g = (t) => (
          t || (t = window.matchMedia(n)), t.matches ? "dark" : "light"
        );
    },
  },
]);

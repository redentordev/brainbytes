  ...
  (A.id = 230),
    ...
    (A.modules = {
      ...
      29135: (A, e, i) => {
        ...
        function w(A) {
          return { ...(0, t.default)(A), isBot: void 0 !== A && r(A) };
        }
        function o({ headers: A }) {
          return w(A.get("user-agent") || void 0);
        }
      },
      29279: (A, e, i) => {
        "use strict";
        ...
        function s() {
          ...
          if (A) {
            if (
              e &&
              "after" === e.phase &&
              !(0, a.isRequestAPICallableInsideAfter)()
            )
              throw Object.defineProperty(
                Error(
            ...
            if (e)
              if ("prerender" === e.type)
                return (0, n.makeHangingPromise)(
                  e.renderSignal,
                  "`connection()`"
                );
              else
                "prerender-ppr" === e.type
                  ? (0, w.postponeWithTracking)(
                      A.route,
                      "connection",
                      e.dynamicTracking
                    )
                  : "prerender-legacy" === e.type &&
                    (0, w.throwToInterruptStaticGeneration)("connection", A, e);
            (0, w.trackDynamicDataInDynamicRender)(A, e);
          }
      ...
      49771: (A, e, i) => {
        ...
        function P(A, e) {
          var i;
          if (null == A || null == (i = A.request) ? void 0 : i.headers) {
            ...
            let i = [];
            for (let [t, r] of A.request.headers)
              e.set("x-middleware-request-" + t, r), i.push(t);
            e.set("x-middleware-override-headers", i.join(","));
          }
        }
        class D extends Response {
          constructor(A, e = {}) {
            super(A, e);
            let i = this.headers,
              s = new Proxy(new n.ResponseCookies(i), {
                get(A, r, w) {
                  switch (r) {
                    case "delete":
                    case "set":
                      return (...w) => {
                        let o = Reflect.apply(A[r], A, w),
                          a = new Headers(i);
                        return (
                    ...
                    default:
                      return o.ReflectAdapter.get(A, r, w);
                  }
                },
              });
            this[a] = {
              ...
              url: e.url
                ? new r.NextURL(e.url, {
                    headers: (0, w.toNodeOutgoingHttpHeaders)(i),
          ...
          static json(A, e) {
            let i = Response.json(A, e);
            return new D(i.body, i);
          }
          static redirect(A, e) {
            let i =
              "number" == typeof e
            ...
            return (
              r.set("Location", (0, w.validateURL)(A)),
              new D(null, { ...t, headers: r, status: i })
            );
          }
          static rewrite(A, e) {
            let i = new Headers(null == e ? void 0 : e.headers);
            return (
              i.set("x-middleware-rewrite", (0, w.validateURL)(A)),
              P(e, i),
              new D(null, { ...e, headers: i })
            );
          }
          static next(A) {
      ...
      50222: (A, e, i) => {
        ...
        let t = i(10708),
          ...
          s = new WeakMap();
        async function P() {
          let A = w.workAsyncStorage.getStore();
          if (!A)
            throw Object.defineProperty(
              new t.InvariantError("Missing workStore in unstable_rootParams"),
              "__NEXT_ERROR_CODE",
        ...
        (() => {
              ...
              226: function (r, w) {
                !(function (o, n) {
                  ...
                  var a = "function",
                    ...
                    J = function (A) {
                      for (var e = {}, i = 0; i < A.length; i++)
                        e[A[i].toUpperCase()] = A[i];
                      return e;
                    },
                    U = function (A, e) {
                      return typeof A === D && -1 !== z(e).indexOf(z(A));
                    },
                    z = function (A) {
                    ...
                    K = function (A, e) {
                      if (typeof A === D)
                        return (
                          (A = A.replace(/^\s\s*/, "")),
                          typeof e === s ? A : A.substring(0, 350)
                        );
                    },
                    W = function (A, e) {
                      for (var i, t, r, w, o, s, D = 0; D < e.length && !o; ) {
                        var u = e[D],
                          c = e[D + 1];
                        for (i = t = 0; i < u.length && !o && u[i]; )
                          if ((o = u[i++].exec(A)))
                            for (r = 0; r < c.length; r++)
                              (s = o[++t]),
                                typeof (w = c[r]) === P && w.length > 0
                                  ? 2 === w.length
                                    ? typeof w[1] == a
                                      ? (this[w[0]] = w[1].call(this, s))
                                      : (this[w[0]] = w[1])
                                    : 3 === w.length
                                      ? typeof w[1] !== a ||
                                        (w[1].exec && w[1].test)
                    ...
                    Z = function (A, e) {
                      for (var i in e)
                        if (typeof e[i] === P && e[i].length > 0) {
                          for (var t = 0; t < e[i].length; t++)
                            if (U(e[i][t], A)) return "?" === i ? n : i;
                        } else if (U(e[i], A)) return "?" === i ? n : i;
                      return A;
                    },
                    _ = {
                      ME: "4.90",
                    ...
                    AA = function (A, e) {
                      ...
                      var i = typeof o !== s && o.navigator ? o.navigator : n,
                        t = A || (i && i.userAgent ? i.userAgent : ""),
                        r = i && i.userAgentData ? i.userAgentData : n,
                        w = e ? F($, e) : $,
                        p = i && i.userAgent == t;
                      return (
                        ...
                        (this.getCPU = function () {
                          var A = {};
                          return (A[f] = n), W.call(A, t, w.cpu), A;
                        }),
                        ...
                        (this.getEngine = function () {
                          var A = {};
                          return (
                            (A[l] = n), (A[g] = n), W.call(A, t, w.engine), A
                          );
                        }),
                        (this.getOS = function () {
                          var A = {};
                        ...
                        (this.setUA = function (A) {
                          return (
                            (t =
                              typeof A === D && A.length > 350 ? K(A, 350) : A),
                            this
                          );
                        }),
                        this.setUA(t),
                  ...
                  (AA.VERSION = "1.0.35"),
                    (AA.BROWSER = J([l, g, u])),
                    (AA.CPU = J([f])),
                    (AA.DEVICE = J([c, b, d, p, h, B, m, v, y])),
                    (AA.ENGINE = AA.OS = J([l, g])),
                    typeof w !== s
                      ? (r.exports && (w = r.exports = AA), (w.UAParser = AA))
                      : i.amdO
                        ? void 0 ===
                            (t = function () {
                              return AA;
                            }.call(e, i, e, A)) || (A.exports = t)
                        : typeof o !== s && (o.UAParser = AA);
                  var Ae = typeof o !== s && (o.jQuery || o.Zepto);
                  if (Ae && !Ae.ua) {
                    var Ai = new AA();
                    (Ae.ua = Ai.getResult()),
                      (Ae.ua.get = function () {
          ...
          function o(A) {
            ...
            var i = (w[A] = { exports: {} }),
              t = !0;
            try {
              r[A].call(i.exports, i, i.exports, o), (t = !1);
            } finally {
              t && delete w[A];
            }
            return i.exports;
      ...
      68207: (A, e, i) => {
        ...
        let P = "force-static",
          D = new r.AppRouteRouteModule({
            ...
            resolvedPagePath:
              "next-metadata-route-loader?filePath=%2Fhome%2Faiz%2Fdev%2Fredentor%2Fbrainbytes%2Fpackages%2Fapp%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__",
            nextConfigOutput: "standalone",
            userland: t,
          }),
          { workAsyncStorage: u, workUnitAsyncStorage: c, serverHooks: l } = D;
        function d() {
      ...
      79214: (A, e) => {
        ...
        class i {
          static get(A, e, i) {
            let t = Reflect.get(A, e, i);
            return "function" == typeof t ? t.bind(A) : t;
          }
          static set(A, e, i, t) {
            return Reflect.set(A, e, i, t);
          }
          static has(A, e) {
      ...
      83374: (A, e, i) => {
        ...
        function n(A) {
          ...
          throw ((A.invalidUsageError ??= e), e);
        }
        function a() {
          let A = r.afterTaskAsyncStorage.getStore();

...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags""
      ...
      async function R(
        ...
        let f = e;
        for (let e of l) e && (f = f.pipeThrough(e));
        return f;
      }
      async function P(
        e,
    ...
    12050: (e, t, r) => {
      ...
      function _(e, { workAsyncStorage: t, workUnitAsyncStorage: r }) {
        let u = async (u, f) => {
          ...
          let m = (null == v ? void 0 : v.href) ?? "",
            b =
              (null == f || null == (_ = f.method)
                ? void 0
                : _.toUpperCase()) || "GET",
            E =
              (null == f || null == (y = f.next) ? void 0 : y.internal) === !0,
          ...
          let N = (0, o.getTracer)().trace(
            ...
            async () => {
              ...
              let y = u && "object" == typeof u && "string" == typeof u.method,
                v = (e) => (null == f ? void 0 : f[e]) || (y ? u[e] : null),
                b = (e) => {
                  var t, r, n;
                  return void 0 !==
              ...
              switch (x) {
                ...
                case "force-cache":
                  (void 0 === S || 0 === S) &&
                    ((I = "fetchCache = force-cache"), (_ = a.INFINITE_CACHE));
              }
              if (
                (void 0 === _
                  ? "default-cache" !== x || w
                    ? "default-no-store" === x
                      ...
                      : w
                        ...
                        : V
                          ? ((_ = 0), (I = "auto no cache"))
                          : ((I = "auto cache"),
                            (_ = A ? A.revalidate : a.INFINITE_CACHE))
                    : ((_ = a.INFINITE_CACHE),
                      (I = "fetchCache = default-cache"))
                  : I || (I = `revalidate: ${_}`),
                !(R.forceStatic && 0 === _) && !V && A && _ < A.revalidate)
              ) {
                if (0 === _)
              ...
              let H = "number" == typeof _ && _ > 0,
                { incrementalCache: F } = R,
                $ =
                  (null == P ? void 0 : P.type) === "request" ||
                  (null == P ? void 0 : P.type) === "cache"
                    ? P
                    : void 0;
              if (F && (H || (null == $ ? void 0 : $.serverComponentsHmrCache)))
                try {
                  n = await F.generateCacheKey(m, y ? u : f);
                } catch (e) {
                  ...
                  return e(u, s)
                    .then(async (e) => {
                      if (
                        ...
                        let t = _ >= a.INFINITE_CACHE ? a.CACHE_ONE_YEAR : _;
                        if (P && "prerender" === P.type) {
        ...
        d = (function () {
          function e() {
            ...
            (t.setLogger = function (e, r) {
              if ((void 0 === r && (r = { logLevel: u.u.INFO }), e === t)) {
                var o,
                  a,
                  i,
                  s = Error(
              ...
              var c = (0, n.mS)("diag"),
                l = (function (e, t) {
                  ...
                  return (
                    ...
                    (t = t || {}),
                    {
                      error: r("error", u.u.ERROR),
                      warn: r("warn", u.u.WARN),
                      info: r("info", u.u.INFO),
                      debug: r("debug", u.u.DEBUG),
                      verbose: r("verbose", u.u.VERBOSE),
                    }
                  );
                })(null != (a = r.logLevel) ? a : u.u.INFO, e);
      ...
      class l {
        ...
        analyze() {
          ...
          let d =
            ...
            (null == (s = this[c].options.nextConfig) || null == (o = s.i18n)
              ? void 0
              : o.defaultLocale);
          ...
          );
        {
          var _,
            ...
            v = {
              ...
              path: d,
              ...(f && {
                sameSite: c.includes((_ = (_ = f).toLowerCase())) ? _ : void 0,
              }),
              ...(p && { secure: !0 }),
              ...(h && {
                priority: l.includes((y = (y = h).toLowerCase())) ? y : void 0,
              }),
              ...(g && { partitioned: !0 }),
            };
          let e = {};
    ...
    41619: (e, t, r) => {
      "use strict";
      r.d(t, { IP: () => l, YA: () => c, hX: () => s, wN: () => u });
      var n = r(75776),
        o = r(66560),
        a = /^([0-9a-f]{32})$/i,
        i = /^[0-9a-f]{16}$/i;
      function s(e) {
        return a.test(e) && e !== n.RH;
      }
      function u(e) {
        return i.test(e) && e !== n.w9;
      }
      function c(e) {
        ...
        var t = {
            ...
            172: (e, t, r) => {
              ...
              (t.registerGlobal = function (e, t, r, n = !1) {
                var a;
                let i = (u[s] =
                  null != (a = u[s]) ? a : { version: o.VERSION });
                if (!n && i[e]) {
                  let t = Error(
    ...
    54969: (e, t, r) => {
      ...
      function c(e) {
        ...
        if (o && i(o)) return null == (r = n[s]) ? void 0 : r[e];
      }
      function l(e, t) {
        t.debug(
          "@opentelemetry/api: Unregistering a global for " + e + " v" + o + "."
        );
        var r = n[s];
        r && delete r[e];
      }
        ...
        c = (function () {
          ...
          return (
            ...
            (e.prototype.setGlobalTracerProvider = function (e) {
              var t = (0, n.$G)(u, this._proxyTracerProvider, s.K.instance());
              return t && this._proxyTracerProvider.setDelegate(e), t;
            }),
            (e.prototype.getTracerProvider = function () {
              return (0, n.mS)(u) || this._proxyTracerProvider;
            }),
            (e.prototype.getTracer = function (e, t) {
              return this.getTracerProvider().getTracer(e, t);
            }),
            (e.prototype.disable = function () {
              (0, n.kv)(u, s.K.instance()),
                (this._proxyTracerProvider = new o.n());
            }),
            e
          );
    ...
    61365: (e, t, r) => {
      "use strict";
      e.exports = r(24332).vendored["react-rsc"].React;
    },
    62105: (e, t) => {
      "use strict";
      function r(e, t) {
          ...
          let {
            ...
            u = await this.batcher.batch(
              ...
              async (u, c) => {
                ...
                if (
                  this.minimalMode &&
                  (null == (l = this.previousCacheItem) ? void 0 : l.key) ===
                    u &&
                ...
                try {
                  if (
                    ...
                    !o &&
                    (c(p), (f = !0), !p.isStale || r.isPrefetch)
                  )
                    return null;
                  let l = await t({
                    hasResolved: f,
                  ...
                  let g = await (0, a.fromResponseCacheEntry)({
                    ...l,
                    isMiss: !p,
                  });
                  if (!g)
  ...
  `);
    ...
    69506: (e, t, r) => {
      ...
      r.r(t),
        r.d(t, {
          ...
          TraceFlags: () => F.X,
          ValueType: () => n,
          baggageEntryMetadataFromString: () => p,
          context: () => Z,
          createContextKey: () => g.n,
          createNoopMeter: () => k,
          createTraceState: () => Y,
          default: () => eh,
          defaultTextMapGetter: () => G,
          defaultTextMapSetter: () => B,
          diag: () => ee,
          isSpanContextValid: () => z.YA,
          isValidSpanId: () => z.wN,
          isValidTraceId: () => z.hX,
          metrics: () => eo,
          propagation: () => ep,
                ...
                ((this._internalState = e
                  ...
                  .reduce(function (e, t) {
                    ...
                    if (-1 !== n) {
                      ...
                      X.test(o) && q.test(a) && !K.test(a) && e.set(o, a);
                    }
                    return e;
                  }, new Map())),
                this._internalState.size > 32 &&
      ...
      var z = r(41619),
        ...
        eo = (function () {
          ...
          return (
            ...
            (e.prototype.setGlobalMeterProvider = function (e) {
              return (0, er.$G)(en, e, i.K.instance());
            }),
        ...
        ei = (0, g.n)("OpenTelemetry Baggage Key");
      function es(e) {
        ...
        ep = (function () {
          ...
          return (
            ...
            (e.prototype.setGlobalPropagator = function (e) {
              return (0, er.$G)(ed, e, i.K.instance());
            }),
    ...
    75776: (e, t, r) => {
      "use strict";
      r.d(t, { RH: () => a, dM: () => i, w9: () => o });
      var n = r(64501),
        o = "0000000000000000",
        a = "00000000000000000000000000000000",
        i = { traceId: a, spanId: o, traceFlags: n.X.NONE };
    },
    88996: (e, t) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      var n = r(90577),
        ...
        p = (function () {
          ...
          return (
            ...
            (e.prototype.disable = function () {
              this._getContextManager().disable(), (0, s.kv)(d, u.K.instance());
            }),
            e
          );
        })();
    ...
    90031: (e, t, r) => {
      ...
      var n = r(90577),
        o = r(66560),
        a = r(89371),
        i = (0, n.n)("OpenTelemetry Context Key SPAN");
      function s(e) {
        return e.getValue(i) || void 0;
      }
      function u() {
        ...
        trace(...e) {
          ...
          p
            ? (null == (t = u.getSpanContext(p)) ? void 0 : t.isRemote) &&
              (y = !0)
            : ((p = (null == i ? void 0 : i.active()) ?? d), (y = !0));
          let m = v();
          return (
            (l.attributes = {
              "next.span_name": f,
            ...
            i.with(p.setValue(_, m), () =>
              this.getTracerInstance().startActiveSpan(f, l, (e) => {
                ...
                y && h.set(m, new Map(Object.entries(l.attributes ?? {})));
                try {

      ...
      9324: (e, t, r) => {
        ...
        async function c(e, { params: t }) {
          try {
            ...
            if (!(await o.im.getByIdAndUserId(e, r.user.id)))
              return Response.json(
                {
                  error:
                    "Material not found or you don't have permission to access it",
                },
                { status: 404 }
              );
            let a = await o.im.TextEntry.getByMaterialId(e);
            return Response.json({ entries: a });
          } catch (e) {
            return (
              console.error("Error fetching text entries:", e),
              Response.json(
        ...
        async function l(e, { params: t }) {
          try {
            ...
            if (!(await o.im.getByIdAndUserId(r, a.user.id)))
              return Response.json(
                {
                  error:
            ...
            let s = await o.im.TextEntry.add({ ...i, materialId: r });
            return Response.json({ entry: s }, { status: 201 });
          } catch (e) {
            return (
              console.error("Error creating text entry:", e),
              Response.json(
        ...
        let p = new i.AppRouteRouteModule({
            definition: {
              ...
              page: "/api/materials/[materialId]/entries/route",
              pathname: "/api/materials/[materialId]/entries",
              filename: "route",
              bundlePath: "app/api/materials/[materialId]/entries/route",
            },
            resolvedPagePath:
              "/home/aiz/dev/redentor/brainbytes/packages/app/src/app/api/materials/[materialId]/entries/route.ts",
